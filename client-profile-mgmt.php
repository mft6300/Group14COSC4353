<!-- http://localhost/Group14COSC4353/client-profile-mgmt.php -->
<!--
  Maybe add option to edit username and password?
  - username
  - password
  - confirm password
  Also add button to cancel making changes?
  - cancel (next to save button)
 -->
